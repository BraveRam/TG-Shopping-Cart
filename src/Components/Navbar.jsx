...
export function Navbar(){
  ...
  return (
     <div className="w-[90%] md:w-[60%] lg:w-[60%] xl:w-[50%] rounded h-[20px] bg-blue-500 flex items-center justify-between p-6 overflow-clip fixed left-0 right-0 top-1 m-auto z-50">
       ...
       <Link className="relative animate-pulse" to="/cart">
        ...
        <p className="absolute bottom-4 left-7 bg-white rounded-full py-[2px] px-[10px] font-bold">{cart.totalQuantity}</p>
       </Link>
     </div>
    )
}